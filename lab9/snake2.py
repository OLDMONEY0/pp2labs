...
font_menu = pygame.font.Font('picsforsnake//font.ttf', 85)
...
game_background = pygame.image.load('picsforsnake//game_background.jpg').convert()
menu_background = pygame.image.load('picsforsnake//menu_background.jpg').convert()
